...
<dt class="house">选择地区</dt>
<dd>
    <?php if(is_array($area_list)){foreach($area_list as $mymps) { ?>  <a href="index.php?mod=post&catid=<?=$catid?>&cityid=<?=$cityid?>&areaid=<?=$mymps['areaid']?>"><?=$mymps['areaname']?></a>
<?php }} ?>
</dd>
</dl>
